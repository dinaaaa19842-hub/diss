...
с методами интеллектуального анализа данных
"""
...
from modules.auth import authenticate_user, get_demo_credentials, get_role_color, get_role_icon
from modules.database import generate_patients_database, search_patients, get_high_risk_patients
from modules.analysis import analyze_prescription_comprehensive, check_drug_interactions, analyze_polypharmacy
from modules.utils import (
    get_custom_css, render_metric_card, render_alert, render_status_badge,
    render_medication_table, render_interaction_card, render_header_with_subtitle,
    COLORS
)
